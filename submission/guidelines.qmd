...
- [Abstract for an oral presentation](#oral_poster) that describes an individual research project;
- [Abstract for a poster presentation](#oral_poster) that describes an individual research project. Scientific research ideas and designs, without yet having data, could be submitted as poster presentations;
- [Abstracts for a symposium](#symposium) that consist of four to five oral presentations on a single research theme;
- [Abstract for a data workshop](#data_workshop) that consists in the presentation of the transformations and statistical analysis of emotion-related data which should last between 45 and 60 minutes.
...
## Abstract for an Oral or a Poster Presentation {#oral_poster}
...
## Abstracts for a Symposium {#symposium}
...
## Abstract for a Data Workshop {#data_workshop}
